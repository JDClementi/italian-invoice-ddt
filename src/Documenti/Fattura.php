...
class Fattura extends LayoutFattura {
	...
	public $TotaleImponibile = 0, $TotaleIva = 0;
	...
	public function StampaRigheTotali() {
		...
		$this->Cell( parent::$MargineDestroTabellaDettagli - $this->MargineSinistroImporto, 7, parent::FormattaNumero( $this->ParteTabellare->totale ), 0, 0, 'R', false );
